...
<div id="leftmost">Popular Books Among Readers</div>
  <div class="carousel">
  <div>
<img  class="img1" style="clear:left;" src="https://images-na.ssl-images-amazon.com/images/I/91fJxgs69QL.jpg" alt="Book" width="200" height="300"></div>
    ...
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          ...
          <button class="btn card_btn">Explore</button>
        </div>
      </div>
    </li>
     <li class="cards_item">
...
function showabout(){
  window.open("https://codepen.io/shreyagour/full/qBmVvyK");
}
</script>